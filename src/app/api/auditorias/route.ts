...
export async function GET() {
  ...
  const { data, error } = await admin
    .from("auditorias")
    .select("id, standard, site_id, empresa, regional, data, status, inspetor_nome, num_colaboradores, tem_ca_divergente, tem_pendencia_assinatura, criado_por_nome, criado_em, atualizado_em, finalizado_em")
